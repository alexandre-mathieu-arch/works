  ...
  <div class="mt-20 border-t border-[#121212]/10 pt-10 dark:border-white/10 doux:border-[#4A4443]/10 nuit:border-[#CDD6F4]/10">
    ...
    <div class="w-full max-w-[280px] space-y-8 md:max-w-[300px] xl:max-w-[320px]">
      ...
      <div>
        ...
        <h3 class="u-h3 mb-3">Archivolto — Architecte collaborateur</h3>
        <ul class="space-y-1.5 text-[13px] leading-[1.6] u-body text-[#121212]/85 dark:text-white/85 doux:text-[#4A4443]/88 nuit:text-[#CDD6F4]/88 list-none p-0">
      ...
      <!-- 2023 -->
      <div>
        <p class="u-legend mb-1 uppercase">2023</p>
        <h3 class="u-h3 mb-3">Architecte indépendant</h3>
        <ul class="space-y-1.5 text-[13px] leading-[1.6] u-body text-[#121212]/85 dark:text-white/85 doux:text-[#4A4443]/88 nuit:text-[#CDD6F4]/88 list-none p-0">
          <li>Transformation immeuble en studio de podcast (Sunikwartz HK) à Bangkok.</li>
          <li>Rénovation maison individuelle à Port-Louis.</li>
          <li>Conception de deux villas jumelles au Maroc.</li>
        </ul>
      </div>

      <!-- 2022 -->
      <div>
        <p class="u-legend mb-1 uppercase">2022</p>
        <h3 class="u-h3 mb-3">Riguidel — Architecte collaborateur</h3>
        <ul class="space-y-1.5 text-[13px] leading-[1.6] u-body text-[#121212]/85 dark:text-white/85 doux:text-[#4A4443]/88 nuit:text-[#CDD6F4]/88 list-none p-0">
      ...
      <!-- 2018-2021 -->
      <div>
        <p class="u-legend mb-1 uppercase">2018 — 2021</p>
        <h3 class="u-h3 mb-3">Brulé Architectes Associés — Architecte collaborateur</h3>
        <ul class="space-y-1.5 text-[13px] leading-[1.6] u-body text-[#121212]/85 dark:text-white/85 doux:text-[#4A4443]/88 nuit:text-[#CDD6F4]/88 list-none p-0">
      ...
      <!-- 2018 -->
      <div>
        <p class="u-legend mb-1 uppercase">2018</p>
        <h3 class="u-h3 mb-3">Collaborations</h3>
        <ul class="space-y-1.5 text-[13px] leading-[1.6] u-body text-[#121212]/85 dark:text-white/85 doux:text-[#4A4443]/88 nuit:text-[#CDD6F4]/88 list-none p-0">
          <li><span class="font-normal text-[#121212] dark:text-white doux:text-[#4A4443] nuit:text-[#CDD6F4]">DDL Architectes :</span> Aménagement urbain rive gauche de Vannes (KCAP Zurich).</li>
          <li><span class="font-normal text-[#121212] dark:text-white doux:text-[#4A4443] nuit:text-[#CDD6F4]">Rich Designer :</span> Conception lumière Club Med Cefalù & Marbella.</li>
        </ul>
      </div>
    </div>
  </div>
