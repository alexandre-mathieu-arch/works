    ...
    <div class="mt-20 pt-8 border-t border-primary-900/10 flex flex-col gap-12">
      ...
      <div class="flex flex-col md:flex-row items-start gap-x-12 gap-y-4">
        <a 
          ...
          target="_blank" 
          download 
          class="inline-flex items-center gap-2 px-0 py-1 u-h4 hover:text-[#121212]/65 dark:hover:text-white/70 transition-all duration-[900ms] ease-[var(--motion-luxury-ease)] no-underline group"
        >
